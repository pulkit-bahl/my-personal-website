  ...
  return (
    <section className="py-0 md:py-0 pt-4 md:pt-0 flex flex-col items-center justify-center text-center px-4">
      <motion.h1
        ...
        className="text-4xl md:text-5xl lg:text-6xl font-bold mb-2 font-heading hero-title mt-1 mobile-fast-animation"
      >
        Hi there, I'm{" "}
      ...
      <motion.p
        ...
        className="text-base md:text-lg lg:text-xl max-w-4xl mx-auto leading-relaxed mt-1 mobile-fast-animation"
      >
        I'm a{" "}
