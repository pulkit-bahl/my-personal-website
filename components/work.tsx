      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <motion.p
            ...
            className="text-muted-foreground uppercase tracking-wider mb-2 mobile-fast-animation"
          >
          ...
          <motion.h2
            ...
            viewport={{ once: true, margin: "-100px" }}
            className="fluid-subheading font-bold mb-8 gradient-text mobile-fast-animation"
          >
            Work Experience
          </motion.h2>
        </div>
