  ...
  const contactInfo = [
    {
      ...
      href: "mailto:Pulkitbahl11@gmail.com",
    },
    {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <motion.h2
            ...
            viewport={{ once: true, margin: "-100px" }}
            className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 gradient-text"
          >
            Contact
          </motion.h2>
        </div>
            ...
            <div className="space-y-6 relative">
              {contactInfo.map((item, index) => (
                <motion.div
                  ...
                  className="flex items-center space-x-4 p-4 rounded-lg hover:bg-gray-50 transition-all duration-300 transform hover:scale-105"
                >
                  ...
                  <div className="flex-grow">
                    <h3 className="text-sm font-medium text-muted-foreground select-all">{item.label}</h3>
                    <p className="text-lg font-semibold select-all">{item.value}</p>
                  </div>
                  <a
                    href={item.href}
