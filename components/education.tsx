    ...
    <section id="education" className="py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-px bg-gradient-to-b from-blue-300 to-purple-300"></div>
          ...
          <div className="space-y-24">
            {educationData.map((item, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-1/2 transform -translate-x-1/2 w-12 h-12 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full flex items-center justify-center z-10">
                  {item.icon}
                </div>
